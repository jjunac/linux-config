...
#    prompt_jj_color2="%{[36m%}"   # Host & user
...
#    prompt_jj_line_1a+="${prompt_jj_color2}%n@%m"
#    prompt_jj_line_1a+=" "
...
#
#    prompt_jj_line_1b=""
#    prompt_jj_line_1b+="${prompt_jj_color2}(%*)-"
#
#    prompt_jj_padding_size=$(( COLUMNS
#                                - 
#    
#
#    export PS1="$prompt_jj_line_1a"+$'\n'+"->>>"
#}
#
#prompt_themes+=( jj )
#prompt jj
...
PROMPT+="%{[91m%}%*"                          # HH:MM:SS
PROMPT+=" "
PROMPT+="%{[36m%}%n%{[93m%}@%{[34m%}%m"   # user@host
PROMPT+=" "
PROMPT+="%{[32m%}%~"                          # path
PROMPT+=" "
PROMPT+="%{[35m%}\$(__git_ps1 '(%s)')"        # git status
PROMPT+=$'\n'
PROMPT+="%{[91m%}>>>"                         # >>>
PROMPT+="%{[0m%} "
